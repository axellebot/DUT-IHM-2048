 ...
 * @author axell
 */
public class BoitePartieGagne extends JDialog implements ActionListener {

    //attribut graphique
    private JButton btnRecommencer, btnFermer;
    private JLabel lblGagne;
    private boolean rejouer;

    public BoitePartieGagne(Fenetre owner) {
        ...
        this.lblGagne = new JLabel("Gagne");
        lblGagne.setFont(new Font("Serif", Font.PLAIN, 36));
